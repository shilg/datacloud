   ...
   /* if(!/http(s*):\/\//.test(location.href)){
    ...
    function showNotice(){
        layer.open({
            ...
            btn: ['知道了'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">扶贫Sass云服务平台上线，支持本级扶贫数据提供给行业部门查询和Excel比对，行业部门用户本级管理</p></pclass></p></div>',
